...
export function UniverseApp() {
  ...
  return <main className="universe-site">
    ...
    <section className="universe-orbits" id="agenda"><div><p>03 · 90-day orbit</p><h2>{agendaHeading}</h2></div><ol>{agenda.map((a,i)=><li key={a.days}><span><Orbit size={18}/>{a.days} days</span><h3>{a.title}</h3><p>{a.copy}</p><LivingArrow/></li>)}</ol></section>
