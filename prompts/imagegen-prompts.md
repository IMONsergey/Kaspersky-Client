# ImageGen prompt specifications

Общие инварианты для всех четырёх вызовов:

- Use case: `productivity-visual`, edit existing portrait A4 page.
- Image 1 is the edit target and the source of truth for every piece of text, logo, page number, line break and text zone.
- Image 2 is a style reference only; do not copy its specific layouts or objects.
- Preserve the exact `1447 × 2048` portrait composition.
- Keep all existing text verbatim and fully legible. Do not translate, rewrite, add, remove or hallucinate text.
